...
using DetailPrototype = Decentraland.Terrain.DetailPrototype;
...
public class GrassIndirectRenderer : MonoBehaviour
{
    ...
    public void SetupComputeBuffers()
    {
        ...
        drawArgs = new GraphicsBuffer(GraphicsBuffer.Target.IndirectArguments, count: 1, GraphicsBuffer.IndirectDrawIndexedArgs.size);

        quadTreeNodesComputeBuffer.SetData(quadTreeNodes.ToArray());
    }

    public void RunFrustumCulling()
    {
        ...
        Matrix4x4 projMatrix = Matrix4x4.Perspective(Camera.main.fieldOfView, Camera.main.aspect, Camera.main.nearClipPlane, 64);
        ...
        quadTreeCullingShader.SetTexture(kernelIndex, "OccupancyTexture", OccupancyMap);
    ...
    public void GenerateScatteredGrass()
    {
        ...
        ScatterGrassShader.SetTexture(kernelIndex, "OccupancyTexture", OccupancyMap);
        ...
        ScatterGrassShader.GetKernelThreadGroupSizes(kernelIndex, out threadGroupSizes_X, out threadGroupSizes_Y, out threadGroupSizes_Z);
