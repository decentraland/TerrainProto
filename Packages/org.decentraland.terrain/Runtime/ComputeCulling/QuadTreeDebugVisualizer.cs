...
public class QuadTreeRenderTextureVisualizer : MonoBehaviour
{
    ...
    public bool showOnlyVisibleNodes = false;
    ...
    public Vector2 worldSize = new Vector2(8192, 8192);
    ...
    private List<int> visibleNodeIndices = new List<int>();
