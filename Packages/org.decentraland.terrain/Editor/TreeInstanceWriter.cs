...
namespace Decentraland.Terrain
{
    public sealed class TreeInstanceWriter
    {
        ...
        private Dictionary<int2, List<TreeInstance>> parcelMap;
        ...
        public void AddTerrain(UnityEngine.Terrain unityTerrain)
        {
            ...
            foreach (var treeInstance in treeInstances)
            {
                ...
                int2 parcel = (int2)floor(position.XZ() / parcelSize);
        ...
        public void Write(Stream stream)
        {
            ...
            TreeInstance[] treeInstances = new TreeInstance[treeInstanceCount];
