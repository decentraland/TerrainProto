...
public static class TerrainMetadataHelper
{
    ...
    {
        float originalMin = (float)metadata["originalMin"];
        float originalMax = (float)metadata["originalMax"];
    ...
    // Helper getters
    public static float GetOriginalMin(Dictionary<string, object> metadata) => (float)metadata["originalMin"];
    public static float GetOriginalMax(Dictionary<string, object> metadata) => (float)metadata["originalMax"];
    public static float GetOriginalAverage(Dictionary<string, object> metadata) => (float)metadata["originalAverage"];
    public static float GetCompressionRatio(Dictionary<string, object> metadata) => (float)metadata["compressionRatio"];
    public static float GetOptimizationStrength(Dictionary<string, object> metadata) => (float)metadata["optimizationStrength"];
}
